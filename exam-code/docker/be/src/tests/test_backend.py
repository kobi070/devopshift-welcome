...
from main import app, save_to_db, get_crypto_prices  # Ensure correct import
...
def test_fetch_price(client, mocker):
    ...
    mocker.patch('main.get_crypto_prices', return_value={
        "bitcoin": {"usd": 50000},
        "xrp": {"usd": 0.60}
    })
    
    mocker.patch('main.save_to_db', return_value=True)  # Simulate DB success
...
def test_fetch_price_api_failure(client, mocker):
    ...
    mocker.patch('main.get_crypto_prices', return_value={})  # Simulate API failure
